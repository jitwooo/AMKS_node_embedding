...
from experiment_util.cross_graph import load_node_name, emb_evaluate, extract_sub_graph_with_level
...
if __name__ == '__main__':
    ...
    embed_model_one = MultiHopWKS()
    embed_model_two = MultiHopWKS()
    ...
    params = CurParams()
    logger = get_logger("ex9_cross_graph_WKS_" + graph_name_one + '-' + graph_name_two)
